...
@section('roles_configuration_tab_content')
    @can('roles.create')
    <button class="btn btn-default text-primary float-right btn-sm" data-toggle="modal-ajax" data-href="{{ route('roles.create') }}" data-target="#addRole"><i class="fa fa-plus"></i> Add</button>
    @endcan
