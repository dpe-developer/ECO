...
@csrf
    <input type="hidden" name ="from_modal_ajax_href" value="{{ route('roles.create') }}">
    <input type="hidden" name ="modal_ajax_target" value="#addRole">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
					<div class="form-group">
					    ...
					    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="@if(old('name')){{ old('name') }}@endif" required>
