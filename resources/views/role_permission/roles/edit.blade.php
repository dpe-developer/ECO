<form method="POST" action="{{ route('roles.update', $role_edit->id) }}" autocomplete="off">
    @csrf
    @method('PUT')
    <input type="hidden" name ="from_modal_ajax_href" value="{{ route('roles.edit', $role_edit->id) }}">
    <input type="hidden" name ="modal_ajax_target" value="#editRole">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
					<div class="form-group">
					    ...
					    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="@if(old('name')){{ old('name') }}@else{{ $role_edit->name }}@endif" required>
                    ...
                    <div class="form-group">
                        ...
                        @foreach($permissions as $key => $permission_data)
                            <div class="col-md-3">
                                ...
                                {{-- <label>{{ $key }}:</label> --}}
                                @foreach ($permission_data->sortBy('name') as $permission)
                                    <div class="checkbox">
                                        <div class="custom-control custom-checkbox">
