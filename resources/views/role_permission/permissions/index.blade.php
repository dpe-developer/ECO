@extends('role_permission.index')
@section('roles_configuration_tab_content')
    @can('permissions.create')
    <button class="btn btn-default text-primary float-right btn-sm" data-toggle="modal-ajax" data-href="{{ route('permissions.create') }}"  data-target="#addPermission"><i class="fa fa-plus"></i> Add</button>
    @endcan
