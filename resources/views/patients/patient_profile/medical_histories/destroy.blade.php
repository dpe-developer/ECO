<div class="modal fade" id="destroyVitalInformation_{{ $vital_information->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body">
    			<form action="{{ route('vital_information.destroy', $vital_information->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <p class="text-left">
