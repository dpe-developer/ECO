<form action="{{ route('appointments.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="createAppointmentModal" data-backdrop="static" data-keyboard="false" role="dialog" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="appointment_date" id="appointmentDate" min="{{ Carbon::now()->format('Y-m-d') }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="appointment_time" id="appointmentTime" class="form-control" required>
                                    <option></option>
                                    <option class="text-danger" disabled value="09:00">9:00am</option>
                                    <option class="text-danger" disabled value="09:30">9:30am</option>
                                    <option class="text-danger" disabled value="10:00">10:00am</option>
                                    <option class="text-danger" disabled value="10:30">10:30am</option>
                                    <option class="text-danger" disabled value="11:00">11:00am</option>
                                    <option class="text-danger" disabled value="11:30">11:30am</option>
                                    <option class="text-danger" disabled value="12:00">12:00pm</option>
                                    <option class="text-danger" disabled value="12:30">12:30pm</option>
                                    <option class="text-danger" disabled value="13:00">1:00pm</option>
                                    <option class="text-danger" disabled value="13:30">1:30pm</option>
                                    <option class="text-danger" disabled value="14:00">2:00pm</option>
                                    <option class="text-danger" disabled value="14:30">2:30pm</option>
                                    <option class="text-danger" disabled value="15:00">3:00pm</option>
                                    <option class="text-danger" disabled value="15:30">3:30pm</option>
                                    <option class="text-danger" disabled value="16:00">4:00pm</option>
                                    <option class="text-danger" disabled value="16:30">4:30pm</option>
                                    <option class="text-danger" disabled value="17:00">5:00pm</option>
                                    <option class="text-danger" disabled value="17:30">5:30pm</option>
                                </select>
                            </div>
                            <div class="form-group">
